...
import { ButtonSizeVariants, ButtonVariants, IconsVariants, ImagesVariants, TextVariants } from '../../constants/VariantsOfComponents';
import { AdvantagesInfo, ExperienceSliderInfo } from '../../constants/constants';
...
const Home = () => {
  ...
  return (
    <>
      <div className='topic'>
        <div className='container'>
          <div className='info'>
            ...
            <Text className='description' variant={TextVariants.h1}>is the <Text>most reliable</Text> panel on the market with <Text>529.122</Text> orders until now</Text>
            <Button size={ButtonSizeVariants.extra_large} variant={ButtonVariants.crypto} text='Get started now' iconPosition='right' icon={IconsVariants.Arrow_crypto} />
          </div>
      ...
      <Slider slides={ExperienceSliderInfo} description='Experience The Naizop Difference' />
